CREATE TABLE IF NOT EXISTS Invoice(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, rate INTEGER, deductableTaxPercentage INTEGER, deductableTaxTime INTEGER);
